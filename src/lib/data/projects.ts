...
export const projects: LabProject[] = [
  ...
  },
  {
    ...
    description:
      "Front-End developer on a multi-tenant SaaS platform built on a scalable microservices backend. Shipped three production applications — a merchant dashboard, a spa booking app, and a mobile-ready backoffice.",
    longDescription:
